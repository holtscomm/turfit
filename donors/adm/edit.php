...
<div class="page">
	...
	<p>
        <label for="title">Donor name (This is all the information you want people to know about this donor):</label><br />
        <input type="text" size="80" length="300" id="title" name="data[donor_name]" value="<?=htmlspecialchars(stripslashes($post['donor_name']))?>" />
    </p>
